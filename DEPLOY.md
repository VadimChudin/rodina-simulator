...
Страница оформлена в светлой гамме сайта SysAT (белый фон, синий #004395,
красный акцент). Собственной шапки с меню сайта у неё нет — при встраивании меню
даёт сам сайт. Чтобы подключить её к сайту:
