...
(function (global) {
  ...
  // корпус роторного затвора в cyclone.webp (замерено по рисунку); циклоны — byH(…, 905, 290)
  const valveOf = (cx) => { const w = Math.round(290 * 0.473); return { x: cx + 0.48 * w, y: 905 + 0.855 * 290, w: 0.2 * w, h: 0.105 * 290 }; };
  const motor = (x, y, drive) => ({ x, y, w: 58, h: 58, kind: "motor", drive });

  /* ------------------------------------------------------------ узлы схемы */
  // drive — привод ПЛК, по которому анимируется узел.
  const ND = {
    truck_in:  { ...byW("truck", 40, 130, 300), kind: "truck", serves: "pit" },
    intake:    { ...byW("intake", 40, 280, 420), kind: "intake", drive: "conv_2", poz: "1–2" },
    m_vor:     { ...motor(150, 522, "vor"), poz: "1", parent: "intake" },
    magnet_3:  { ...byW("magnet", 488, 500, 64), kind: "magnet", poz: "3" },
    noria_4:   { ...byH("noria", 590, 80, 590), kind: "noria", drive: "noria_4", poz: "4" },
    ost:       { ...byW("debearder", 790, 198, 110), kind: "op", drive: "ost", poz: "5" },
    bun_61:    { ...byW("hopper", 824, 306, 70), kind: "hopper", level: "bo_1", poz: "6.1" },
    ksp:       { ...byW("muz", 760, 408, 290), kind: "muz", drive: "ksp", poz: "6" },
    m_biter:   { ...motor(1062, 420, "ksp_biter"), poz: "6", parent: "ksp" },
    fan_asp_1: { ...byW("fan", 975, 120, 100), kind: "fan", drive: "fan_asp_1", poz: "7" },
    noria_8:   { ...byH("noria", 1170, 80, 590), kind: "noria", drive: "noria_8", poz: "8" },
    bun_9:     { ...byW("hopper", 1360, 206, 80), kind: "hopper", level: "bo_2", poz: "9" },
    tor:       { ...byW("tor", 1370, 318, 250), kind: "tor", drive: "tor", poz: "10" },
    m_tor_biter: { ...motor(1636, 470, "tor_biter"), poz: "10", parent: "tor" },
    fan_asp_2: { ...byW("fan", 1535, 110, 100), kind: "fan", drive: "fan_asp_2", poz: "11" },
    noria_12:  { ...byH("noria", 1760, 80, 590), kind: "noria", drive: "noria_12", poz: "12" },
    flow_1:    { ...byW("diverter", 1958, 210, 90), kind: "diverter", drive: "flow_1", poz: "13.1" },
    bt_14_1:   { ...byW("trier", 1960, 305, 220), kind: "trier", drive: "trier_1", drive2: "trier_2_1", poz: "14.1" },
    m_trier_1: { ...motor(2192, 322, "trier_1"), poz: "14.1 N1", parent: "bt_14_1" },
    m_trier_2_1: { ...motor(2256, 322, "trier_2_1"), poz: "14.1 N2", parent: "bt_14_1" },
    bt_14_2:   { ...byW("trier", 1960, 425, 220), kind: "trier", drive: "trier_1_2", drive2: "trier_2_2", poz: "14.2" },
    m_trier_1_2: { ...motor(2192, 470, "trier_1_2"), poz: "14.2 N1", parent: "bt_14_2" },
    m_trier_2_2: { ...motor(2256, 470, "trier_2_2"), poz: "14.2 N2", parent: "bt_14_2" },
    noria_15:  { ...byH("noria", 2390, 80, 590), kind: "noria", drive: "noria_15", poz: "15" },
    flow_2:    { ...byW("diverter", 2588, 210, 90), kind: "diverter", drive: "flow_2", poz: "13.2" },
    bun_16:    { ...byW("hopper", 2569, 300, 80), kind: "hopper", level: "bo_3", poz: "16" },
    pnev:      { ...byW("pneumo", 2560, 412, 350), kind: "sp", drive: "pnev", poz: "18" },
    fan_pnev:  { ...byW("fan", 2915, 212, 82), kind: "fan", drive: "fan_pnev", poz: "18" },
    fan_asp_3: { ...byW("fan", 2745, 110, 100), kind: "fan", drive: "fan_asp_3", poz: "19" },
    noria_20:  { ...byH("noria", 3035, 80, 590), kind: "noria", drive: "noria_20", poz: "20" },
    ...
    // шлюзовые затворы — это роторные затворы, нарисованные внизу спрайта циклона
    shl_1:     { ...valveOf(60), kind: "sluice", drive: "shl_1", poz: "7" },
    shl_2:     { ...valveOf(265), kind: "sluice", drive: "shl_2", poz: "11" },
    shl_3:     { ...valveOf(470), kind: "sluice", drive: "shl_3", poz: "19" },
    conv_22_5: { ...byW("screw", 60, 1340, 500), kind: "screw", drive: "conv_22_5", poz: "22.5" },
    conv_22_1: { ...byW("screw", 700, 1440, 480), kind: "screw", drive: "conv_22_1", poz: "22.1" },
    noria_23:  { ...byH("noria", 1290, 1140, 460), kind: "noria", drive: "noria_23", poz: "23" },
    bun_A:     { ...byH("silo", 1500, 1240, 330), kind: "silo", level: "A", poz: "25", letter: "А" },
    bun_B:     { ...byH("silo", 1880, 1240, 330), kind: "silo", level: "B", poz: "25", letter: "Б" },
    noria_24:  { ...byH("noria", 1690, 1140, 460), kind: "noria", drive: "noria_24", poz: "24" },
    truck_A:   { ...byW("truck", 1450, 1590, 220), kind: "truck", serves: "A" },
    truck_B:   { ...byW("truck", 1843, 1590, 220), kind: "truck", serves: "B" },
  ...
  for (const [id, n] of Object.entries(ND)) {
    ...
    switch (n.kind) {
      case "noria":
        // вход — край приёмного лотка башмака, выход — срез носка головки
        a.in = [px(0.03), py(0.845)]; a.out = [px(0.93), py(0.21)];
        a.col = px(0.50); a.top = py(0.14); a.bot = py(0.88);
        a.win = [0.40, 0.12, 0.20, 0.76];
        break;
      case "intake":
        a.beltY = py(0.50); a.bx1 = px(0.14); a.bx2 = px(0.88);
        a.out = [px(0.96), py(0.94)];              // срез разгрузочного лотка конвейера
        break;
      case "magnet": a.in = [px(0.5), py(0.02)]; a.out = [px(0.5), py(0.98)]; break;
      case "op": a.in = [px(0.08), py(0.12)]; a.out = [px(0.96), py(0.80)]; break;
      case "hopper": a.in = [px(0.5), py(0.075)]; a.out = [px(0.5), py(0.87)];
        a.body = [0.16, 0.10, 0.68, 0.46]; a.cone = [0.20, 0.58, 0.60, 0.30]; break;
      case "muz":
        // две выпускные воронки под корпусом: правая — зерно, левая — отходы
        a.in = [px(0.34), py(0.01)]; a.out = [px(0.76), py(0.845)];
        a.waste = [px(0.40), py(0.845)]; a.duct = [px(0.855), py(0.08)];
        break;
      case "tor":
        a.in = [px(0.12), py(0.01)]; a.out = [px(0.442), py(0.872)];
        a.waste = [px(0.214), py(0.872)]; a.duct = [px(0.66), py(0.05)];
        break;
      case "trier":
        // вход в торец верхнего цилиндра; зерно и отходы — из нижнего лотка (правый и левый край)
        a.in = [px(0.10), py(0.03)]; a.out = [px(0.66), py(0.87)]; a.waste = [px(0.17), py(0.86)];
        break;
      case "sp":
        // приёмник в верхнем конце деки, выпускные лотки в нижнем, патрубок вентилятора
        a.in = [px(0.14), py(0.03)]; a.out = [px(0.72), py(0.56)];
        a.waste = [px(0.66), py(0.56)]; a.duct = [px(0.94), py(0.15)];
        break;
      case "silo":
        a.in = [px(0.5), py(0.01)]; a.out = [px(0.46), py(0.96)];
        a.body = [0.10, 0.13, 0.80, 0.53]; a.cone = [0.12, 0.66, 0.76, 0.24];
        break;
      case "cyclone": a.in = [px(0.04), py(0.20)]; a.out = [px(0.585), py(0.99)]; break;
      ...
      // загрузочные патрубки сверху, выпуск снизу у конца по ходу продукта
      case "screw": a.l = px(0.15); a.r = px(0.78); a.y = py(0.40);
        a.p1 = [px(0.175), py(0.06)]; a.p2 = [px(0.675), py(0.06)];
        a.outR = [px(0.77), py(0.60)]; a.outL = [px(0.06), py(0.60)]; break;
  ...
  const DUCTS = [
    { id: "fan_asp_1", poz: "АС-1", pts: [A.ksp.duct, [A.ksp.duct[0], 172], [ND.fan_asp_1.x + 10, 172],
      [ND.fan_asp_1.x + 50, 44], [30, 44], [30, 960], A.cyc_1.in] },
    { id: "fan_asp_2", poz: "АС-2", pts: [A.tor.duct, [A.tor.duct[0], 160], [ND.fan_asp_2.x + 10, 160],
      [ND.fan_asp_2.x + 50, 32], [236, 32], [236, 960], A.cyc_2.in] },
    { id: "fan_asp_3", poz: "АС-3", pts: [A.pnev.duct, [A.pnev.duct[0], 160], [ND.fan_asp_3.x + 10, 160],
      [ND.fan_asp_3.x + 50, 20], [442, 20], [442, 960], A.cyc_3.in] },
  ];

  // Короткие патрубки: выпуск оперативного бункера → приёмник машины под ним.
  const LINKS = [[A.bun_61.out, A.ksp.in], [A.bun_9.out, A.tor.in], [A.bun_16.out, A.pnev.in]];
  ...
  // Все трассы самотёком: каждая идёт от выпускного патрубка машины вниз к приёмнику.
  const sx = (id, k) => A[id][k][0];
  const top = (id) => A[id].p1[1];
  ...
  el("c_4_61", { T: 1.2, pts: [A.noria_4.out, [A.noria_4.out[0], A.bun_61.in[1] - 14], [A.bun_61.in[0], A.bun_61.in[1] - 14], A.bun_61.in] });
  el("ost", { drive: "ost", T: 3, pts: through("ost") });
  el("c_ost_61", { T: 0.8, pts: chuteTo(A.ost.out, A.bun_61.in) });
  el("ksp", { drive: "ksp", T: 5, pts: [A.ksp.in, [A.ksp.in[0] + 40, ND.ksp.y + 70], [A.ksp.out[0], ND.ksp.y + 130], A.ksp.out] });
  el("c_ksp_8", { T: 1.2, pts: [A.ksp.out, [A.ksp.out[0], A.noria_8.in[1]], A.noria_8.in] });
  el("c_ksp_221", { T: 2, pts: [A.ksp.waste, [A.ksp.waste[0], 1090], [sx("conv_22_1", "p1"), 1090], A.conv_22_1.p1] });
  el("c_ksp_222", { T: 3, pts: [A.ksp.waste, [A.ksp.waste[0], 1050], [sx("conv_22_2", "p2"), 1050], A.conv_22_2.p2] });
  el("noria_8", { drive: "noria_8", T: 5, pts: lift("noria_8") });
  el("c_8_9", { T: 1, pts: chuteTo(A.noria_8.out, A.bun_9.in) });
  el("tor", { drive: "tor", T: 6, pts: [A.tor.in, [A.tor.in[0] + 30, ND.tor.y + 100], [A.tor.out[0], ND.tor.y + 190], A.tor.out] });
  el("c_tor_12", { T: 1.2, pts: [A.tor.out, [A.tor.out[0], A.noria_12.in[1]], A.noria_12.in] });
  el("c_tor_222", { T: 3, pts: [A.tor.waste, [A.tor.waste[0], 1010], [sx("conv_22_2", "p2"), 1010], A.conv_22_2.p2] });
  el("noria_12", { drive: "noria_12", T: 5, pts: lift("noria_12") });
  el("c_12_f1", { T: 0.8, pts: chuteTo(A.noria_12.out, A.flow_1.in) });
  el("c_f1_t1", { T: 0.6, pts: [A.flow_1.oa, A.bt_14_1.in] });
  el("c_f1_t2", { T: 1.6, pts: [A.flow_1.oa, [ND.bt_14_1.x - 20, A.flow_1.oa[1] + 20], [ND.bt_14_1.x - 20, A.bt_14_2.in[1]], A.bt_14_2.in] });
  const byT = ND.bt_14_1.x + ND.bt_14_1.w;
  el("c_f1_15", { T: 1.8, pts: [A.flow_1.ob, [A.flow_1.ob[0] + 20, A.flow_1.ob[1] + 18], [byT + 170, A.flow_1.ob[1] + 18],
    [byT + 170, A.noria_15.in[1] - 30], [A.noria_15.in[0] - 10, A.noria_15.in[1] - 30], [A.noria_15.in[0] - 10, A.noria_15.in[1]], A.noria_15.in] });
  ...
  el("c_t1_15", { T: 1.6, pts: [A.bt_14_1.out, [byT + 150, A.bt_14_1.out[1]], [byT + 150, A.noria_15.in[1]], A.noria_15.in] });
  el("c_t2_15", { T: 1.2, pts: [A.bt_14_2.out, [byT + 150, A.bt_14_2.out[1]], [byT + 150, A.noria_15.in[1]], A.noria_15.in] });
  el("c_t1_224", { T: 2, pts: [A.bt_14_1.waste, [ND.bt_14_1.x - 45, A.bt_14_1.waste[1]],
    [ND.bt_14_1.x - 45, 880], [sx("conv_22_4", "p1"), 880], A.conv_22_4.p1] });
  el("c_t2_224", { T: 1.2, pts: [A.bt_14_2.waste, [A.bt_14_2.waste[0], 870], [sx("conv_22_4", "p1"), 870], A.conv_22_4.p1] });
  el("noria_15", { drive: "noria_15", T: 5, pts: lift("noria_15") });
  el("c_15_f2", { T: 0.8, pts: chuteTo(A.noria_15.out, A.flow_2.in) });
  el("c_f2_16", { T: 0.6, pts: [A.flow_2.oa, A.bun_16.in] });
  ...
  el("c_sp_20", { T: 1, pts: [A.pnev.out, [A.pnev.out[0], A.noria_20.in[1]], A.noria_20.in] });
  el("c_sp_223", { T: 2, pts: [A.pnev.waste, [A.pnev.waste[0], 1020], [sx("conv_22_3", "p2"), 1020], A.conv_22_3.p2] });
  ...
  [1, 2, 3].forEach((k) => {
    el("shl_" + k, { drive: "shl_" + k, T: 1.2, pts: [A["shl_" + k].in, A["cyc_" + k].out], dust: true });
    el("c_shl" + k + "_225", { T: 0.8, pts: [A["cyc_" + k].out, [A["cyc_" + k].out[0], top("conv_22_5")]], dust: true });
  });
  el("conv_22_5", { drive: "conv_22_5", T: 7, pts: screw("conv_22_5") });
  el("c_225_221", { T: 1, pts: [A.conv_22_5.outR, [A.conv_22_5.outR[0], top("conv_22_1") - 18], [sx("conv_22_1", "p1") - 20, top("conv_22_1") - 18], A.conv_22_1.p1] });
  el("conv_22_1", { drive: "conv_22_1", T: 7, pts: screw("conv_22_1") });
  el("c_221_23", { T: 1, pts: [A.conv_22_1.outR, [A.conv_22_1.outR[0], A.noria_23.in[1]], A.noria_23.in] });
  ...
  el("c_224_223", { T: 1.2, pts: [A.conv_22_4.outR, [A.conv_22_4.outR[0], 1000], [sx("conv_22_3", "p2") + 20, 1000], A.conv_22_3.p2] });
  el("conv_22_3", { drive: "conv_22_3", T: 7, pts: screw("conv_22_3", true) });
  el("c_223_222", { T: 1.2, pts: [A.conv_22_3.outL, [A.conv_22_3.outL[0], 1200], [sx("conv_22_2", "p2") + 20, 1200], A.conv_22_2.p2] });
  el("conv_22_2", { drive: "conv_22_2", T: 7, pts: screw("conv_22_2", true) });
  el("c_222_24", { T: 1, pts: [A.conv_22_2.outL, [A.conv_22_2.outL[0], 1480], [A.noria_24.in[0] - 30, 1480], [A.noria_24.in[0] - 30, A.noria_24.in[1]], A.noria_24.in] });
  el("noria_24", { drive: "noria_24", T: 5, pts: lift("noria_24") });
  el("c_24_B", { T: 1, pts: chuteTo(A.noria_24.out, A.bun_B.in) });
  ...
  /* ------------------------------------------------------- автотранспорт */
  const TRUCK = {
    // Кабина в спрайте слева: машина едет только кабиной вперёд (влево).
    // Самосвал к яме подаётся задним ходом (кузовом к решётке) и уезжает вперёд.
    truck_in: { key: "pit", kg: 4200, rate: 420, from: -600, exit: -600, auto: () => S.levels.pit < 0.3 },
    truck_out: { key: "V", kg: 8000, rate: 700, from: 600, exit: -600, auto: () => S.levels.V > 0.72 },
    truck_A: { key: "A", kg: 2500, rate: 350, from: 600, exit: -600, auto: () => S.levels.A > 0.72 },
    truck_B: { key: "B", kg: 2500, rate: 350, from: 600, exit: -600, auto: () => S.levels.B > 0.72 },
  };
  ...
  function stepTrucks(dt) {
    for (const [id, t] of Object.entries(S.trucks)) {
      ...
      if (t.phase === "park") {
        ...
        if (move(c.exit)) { t.phase = "away"; t.x = c.exit; t.t = 0; }
      }
    }
  }
